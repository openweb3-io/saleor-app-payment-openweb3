...
export const AddOpenweb3CredentialsForm = ({
  configurationId,
}: {
  ...
  const { data: openweb3ConfigurationData } =
  ...
  useEffect(() => {
    if (openweb3ConfigurationData) {
      reset(openweb3ConfigurationData);
    }
  }, [openweb3ConfigurationData, reset]);
